...
class EcoFriendlyPage(BasePage):
    ...
    @allure.step('Add product to compare')
    ...
    @allure.step('Check that product added to compare')
    ...
    @allure.step('Check that page has alert')
    ...
    @allure.step('Check that right product page is open')
    ...
    @allure.step('Check that product added to cart')
